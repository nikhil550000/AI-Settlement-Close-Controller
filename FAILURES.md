...
- **An append-only session log** — one entry per session, five fixed subheads: **Built / Broke / Cut / Decided / Next.** The **Broke** field is mandatory and written whether or not anything broke. Across twenty sessions, six record "nothing broke" and say why; that is what makes the other fourteen worth reading.
